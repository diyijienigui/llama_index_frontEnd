<template>
  <div class="flex flex-col h-screen">
    ...
    >
      <div class="text-2xl font-bold">ChatDOC</div>
    ...
    <div class="sticky bottom-0 w-full p-6 pb-8 bg-gray-100">
      ...
      <div class="flex">
        ...
        />
        <button class="btn" @click="sendChatMessage()">
          {{ "发送" }}
        </button>
      </div>
    </div>
...
const sendChatMessage = async (content: string = messageContent.value) => {
  try {
    ...
    messageList.value.push({ role: "assistant", content: String(res.answer.response)});
